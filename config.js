...
const CONFIG = {
  JSONBIN: {
    ...
    API_KEY: '$2a$10$9/4QZJ8ZBQ2Ogrk4WPyjzOeMcORkwX/8LsRFS6cYgwqLJtLpHjJgW',
  ...
  WEEKLY_CHALLENGES: [
    {
      id: 'notes_8000',
      title: '8000노트 달성',
      desc: '이번 주 총 8,000개 이상의 노트를 연습하세요.',
      icon: '🎵', goal: 8000, unit: '노트',
      page: 'builder',
      reward: { xp: 500, label: '500 XP' },
      topReward: { xp: 300, label: '+300 XP (상위 2명)' },
    },
    {
      id: 'pomo_streak_3',
      title: '3일 연속 포모도로',
      desc: '3일 이상 연속으로 포모도로 세션을 완료하세요.',
      icon: '🍅', goal: 3, unit: '일',
      page: 'pomo',
      reward: { xp: 400, label: '400 XP' },
      topReward: { xp: 200, label: '+200 XP (상위 2명)' },
    },
    {
      id: 'repertoire_add_3',
      title: '레퍼토리 3곡 추가',
      desc: '이번 주 새 곡을 3곡 이상 레퍼토리에 등록하세요.',
      icon: '📋', goal: 3, unit: '곡',
      page: 'repertoire',
      reward: { xp: 350, label: '350 XP' },
      topReward: { xp: 150, label: '+150 XP (상위 2명)' },
    },
    {
      id: 'mastered_1',
      title: '곡 마스터 1곡',
      desc: '1곡 이상을 Mastered 상태로 올리세요.',
      icon: '🏆', goal: 1, unit: '곡',
      page: 'repertoire',
      reward: { xp: 600, label: '600 XP' },
      topReward: { xp: 400, label: '+400 XP (상위 2명)' },
    },
    {
      id: 'practice_5days',
      title: '주 5일 연습',
      desc: '이번 주 5일 이상 연습 일지를 기록하세요.',
      icon: '📅', goal: 5, unit: '일',
      page: 'builder',
      reward: { xp: 450, label: '450 XP' },
      topReward: { xp: 250, label: '+250 XP (상위 2명)' },
    },
    {
      id: 'bpm_up_10',
      title: 'BPM +10 도전',
      desc: '스튜디오에서 BPM을 10 이상 높여 메트로놈을 10분 이상 사용하세요.',
      icon: '🥁', goal: 10, unit: '분',
      page: 'studio',
